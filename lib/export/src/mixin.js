...
function handleExportAndPrint($xetable, options, isPrint) {
  ...
  Object.assign($xetable.exportParams, {
    ...
    isFooter: hasFooter && (_ctor.default.isBoolean(defOpts.isFooter) ? defOpts.isFooter : true),
    isColgroup: _ctor.default.isBoolean(defOpts.isColgroup) ? defOpts.isColgroup : true,
